...
# mini2_data = Path('LearnData/Generation/DLON3/project/week2')

# p_list = mini2_data / 'product-list.txt'
# product_list_read = open(p_list)

# c_list = mini2_data / 'courier-list.txt'
# courier_list_read = open(c_list)
...
# print(filedir)
# file_name = 'C:\LearnData\Generation\DLON3\project\week2\product-list.csv'
# data = os.path.join(filedir, 'C:\LearnData\Generation\DLON3\project\week2\product-list.csv')


# def product_list_write():
#     with open('C:\LearnData\Generation\DLON3\project\week2\product-list.csv', mode='w') as outfile:
#         csv.product_list_write(product_list, outfile)
...
#     with open('C:\LearnData\Generation\DLON3\project\week2\product-list.csv', mode='r+') as infile:
#         global product_list_read
#         product_list_read = csv.load(infile)
#         return(product_list_read)

    # def cancel(): 
    #     if cancel == 'c'and 'C':
    #         print('you have canceled your action.')
    #         return product_menu(product_list n-1)
